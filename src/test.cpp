    ...
    try
    {
        ...
        area->write(
          { 0xE9, 0x0B, 0x00, 0x00, 0x00, 0xD1, 0x5A, 0xC1, 0xD1, 0xF1,
            0xED, 0xD1, 0x5A, 0xC1, 0xD1, 0xF1, 0x48, 0xB8, 0x48, 0x65,
            0x6C, 0x6C, 0x6F, 0x2C, 0x20, 0x57, 0x48, 0x8D, 0x4C, 0x24,
            0xF2, 0x48, 0x89, 0x44, 0x24, 0xF2, 0xB8, 0x0A, 0x00, 0x00,
            0x00, 0xC7, 0x44, 0x24, 0xFA, 0x6F, 0x72, 0x6C, 0x64, 0x66,
            0x89, 0x44, 0x24, 0xFE, 0xB8, 0x01, 0x00, 0x00, 0x00, 0x48,
            0xC7, 0xC7, 0x01, 0x00, 0x00, 0x00, 0x48, 0x89, 0xCE, 0x48,
            0xC7, 0xC2, 0x0E, 0x00, 0x00, 0x00, 0x0F, 0x05, 0xC7, 0x04,
            0x25, 0x00, 0x00, 0x37, 0x13, 0x39, 0x05, 0x00, 0x00, 0xB8,
            0x3C, 0x00, 0x00, 0x00, 0x48, 0xC7, 0xC7, 0x00, 0x00, 0x00,
            0x00, 0x0F, 0x05, 0xC3 });
    #else
        area->write(
          { 0xE9, 0x0B, 0x00, 0x00, 0x00, 0xD1, 0x5A, 0xC1, 0xD1, 0xF1,
