...
$(XKLIB_OBJ_DEBUG): %$(XKLIB_OBJ_DEBUG_OUT): %.cpp $(PCH_COMPILED_DBG) $(XKLIB_DEPS) cryptopplib
	$(CXX) -c -o $@ $< $(CPPFLAGS_DEBUG)

$(XKLIB_OBJ_RELEASE): %$(XKLIB_OBJ_RELEASE_OUT): %.cpp $(PCH_COMPILED_REL) $(XKLIB_DEPS) cryptopplib
...
## TEST
$(XKLIB_TEST_OBJ_DEBUG): %$(XKLIB_OBJ_DEBUG_OUT): %.cpp $(PCH_COMPILED_DBG) $(XKLIB_DEPS) cryptopplib
	$(CXX) -c -o $@ $< $(CPPFLAGS_DEBUG)

$(XKLIB_TEST_OBJ_RELEASE): %$(XKLIB_OBJ_RELEASE_OUT): %.cpp $(PCH_COMPILED_REL) $(XKLIB_DEPS) cryptopplib
	$(CXX) -c -o $@ $< $(CPPFLAGS_RELEASE)

$(XKLIB_TEST_DEBUG): $(XKLIB_TEST_OBJ_DEBUG) $(XKLIB_OBJ_DEBUG)
	$(CXX) -o $@ $(XKLIB_TEST_OBJ_DEBUG) $(XKLIB_OBJ_DEBUG) $(CPPFLAGS_DEBUG) $(DLOPEN_LIB) $(DBGHELP_LIB) $(PTHREAD_LIB) $(CRYPTOPP_LIB)

$(XKLIB_TEST_RELEASE): $(XKLIB_TEST_OBJ_RELEASE) $(XKLIB_OBJ_RELEASE)
